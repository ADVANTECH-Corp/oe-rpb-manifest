...
To get an official release version, you can assign the corresponding tag & XML, e.g. 410cLBV112C.
```
repo init -u https://github.com/ADVANTECH-Corp/oe-rpb-manifest.git -b krogoth-EdgeSense -m 410cLBV112C.xml
```
