...
To get an official release version, you can assign the corresponding tag & XML, e.g. 410cLBV112B.
```
repo init -u https://github.com/ADVANTECH-Corp/oe-rpb-manifest.git -b refs/tags/410cLBV112B -m 410cLBV112B.xml
```
